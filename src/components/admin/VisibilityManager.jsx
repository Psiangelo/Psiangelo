...
const GROUPS = [
  {
    ...
    items: [
      ...
      { key: 'estudos',      label: 'Estudos · Trilhas',               url: '/estudos' },
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'ensaioDestaque',    label: 'Ensaio em destaque (bloco grande do último ensaio publicado)' },
  ...
  {
    label: 'Blog',
    hint: 'Controla o que aparece no fim de cada post individual e no fim das listagens.',
    items: [
